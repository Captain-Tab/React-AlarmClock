...
const TomatoHistoryChart = (props: any) => {
  ...
  useEffect(() => {
    const width = document.getElementsByClassName('charts-container')[0].clientWidth * 3.4;
    const height = document.getElementsByClassName('charts-container')[0].clientHeight;
...
export default connect(mapStateToProps)(TomatoHistoryChart);